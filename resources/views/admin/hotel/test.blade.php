...
<body class="stretched" onload="initMap()">
									...
									<div class="col-lg-6 col-md-8">
										<div class="entry-c">
											...
											<ul class="entry-meta clearfix">
												<li><i class="icon-star3 color"></i> <i class="icon-star3 color"></i> <i class="icon-star3 color"></i> <i class="icon-star3 color"></i> <i class="icon-star-half-full color"></i></li>
												<li><i class="icon-line-map"></i><a href="#"> Nusa Dua</a></li>
												<li><i class="icon-map-marker2"></i> <a href="https://maps.google.com/maps?q=<?php echo $adress; ?>" data-lightbox="iframe">View map</a></li>
											</ul>
											<div class="entry-content">
												<div class="clearfix" style="margin-bottom: 10px;">
													<i class="i-rounded i-small i-bordered icon-wifi-full"  data-toggle="tooltip" data-placement="top" title="WiFi"></i>
									...
									<div class="col-lg-6 col-md-8">
										<div class="entry-c">
											...
											<ul class="entry-meta clearfix">
												...
												<li><i class="icon-map-marker2"></i> <a href="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNfBHPrMUi-HvkQlbQMdBlALqUDvEbfxI&callback=initMap" data-lightbox="iframe">View map</a></li>
									...
									<div class="col-lg-6 col-md-8">
										<div class="entry-c">
											...
											<ul class="entry-meta clearfix">
												<li><i class="icon-star3 color"></i> <i class="icon-star3 color"></i> <i class="icon-star3 color"></i> <i class="icon-star3 color"></i> <i class="icon-star-half-full color"></i></li>
												<li><i class="icon-line-map"></i><a href="#"> Nusa Dua</a></li>
												<li><i class="icon-map-marker2"></i> <a href="https://maps.google.com/maps?q=<?= $adress ?>" data-lightbox="iframe">View map</a></li>
											</ul>
											<div class="entry-content">
												<div class="clearfix" style="margin-bottom: 10px;">
													<i class="i-rounded i-small i-bordered icon-wifi-full"  data-toggle="tooltip" data-placement="top" title="WiFi"></i>
	...
	<script>
		...
		function initMap() {
			...
			geocoder.geocode({'address': 'fagersta vilhelmina'}, function(results, status) {
			  if (status === 'OK') {
	...
	<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBNfBHPrMUi-HvkQlbQMdBlALqUDvEbfxI">
    </script>
